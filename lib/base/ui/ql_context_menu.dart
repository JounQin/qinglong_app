...
///
/// When open, the [QlCupertinoContextMenu] shows the child, or the widget returned
...
class QlCupertinoContextMenu extends StatefulWidget {
  ...
  ///
  /// When the [QlCupertinoContextMenu] is long-pressed, the menu will open and
  ...
  /// doesn't size itself.
  ///
  /// When the [QlCupertinoContextMenu] is "closed", this widget acts like a
  ...
  /// [QlCupertinoContextMenu] is open.
  ///
